...
// Checking if OnAddFragmentInteractionListener is implemented
//    @Override
...
//        }
//        else{
//            throw new RuntimeException(context.toString()+ "must implement OnAddFragmentInteractionListener");
//        }
//    }
...
//        DatabaseReference reference = FirebaseDatabase.getInstance().getReference(path+"/HabitEvents");
//        Query dbHabitEvent = reference.orderByChild("Title").equalTo(habitEventTitle);

// TODO: Need to use only one DatabaseReference
//        DatabaseReference ref = FirebaseDatabase.getInstance()
//                .getReference(path+"/HabitEvents/"+habitEventTitle+timestamp);

//        dbHabitEvent.addValueEventListener(new ValueEventListener() {
//            @Override
